...
```
![Relational Model](Data Storing/design/Relational Model.png)
```
...
```
![Translasi ERD1](Data Storing/design/Pemetaan ERD3.png)
```
...
```
![Translasi ERD1](Data Storing/design/Pemetaan ERD4.png)
```
...
```
![Translasi ERD1](Data Storing/design/Pemetaan ERD2.png)
```
...
foreign key:
1. Manhwa_Info(Serialization) -> Serialization(IDSerialization)
2. Manhwa_Statistic(Manhwa) -> Manhwa_Info(IDManhwa)
3. Manhwa_Genre(Manhwa) -> Manhwa_Info(IDManhwa)
4. Manhwa_Genre(Genre) -> Genre(IDGenre)
5. Manhwa_Author(Manhwa) -> Manhwa_Info(IDManhwa)
6. Manhwa_Author(Author) -> Author(IDAuthor)
7. Liked_by(Manhwa) -> Manhwa_Info(IDManhwa)
8. Liked_by(User) -> User(IDUser)
9. User_Telp(User) -> User(IDUser)

## Screenshots of the program
### Data Scraping
- Library Import
```
![Library Import](Data Scraping/screenshot/Library Import.png)
```
- Funtion and Procedure
```
![Library Import](Data Scraping/screenshot/Function & procedure.png)
```
```
![Library Import](Data Scraping/screenshot/Function & procedure2.png)
```
```
![Library Import](Data Scraping/screenshot/Function & procedure3.png)
```
```
![Library Import](Data Scraping/screenshot/Function & procedure4.png)
```
- Main Program
```
![Library Import](Data Scraping/screenshot/main program.png)
```
```
![Library Import](Data Scraping/screenshot/main program2.png)
```
```
![Library Import](Data Scraping/screenshot/main program3.png)
```
- Program succesfully run
```
![Library Import](Data Scraping/screenshot/Ngambil data2.png)
```
- Data convert to csv
```
![Library Import](Data Scraping/screenshot/data convert to csv.png)
```
```
![Library Import](Data Scraping/screenshot/data convert to csv2.png)
```
```
![Library Import](Data Scraping/screenshot/data convert to csv3.png)
```
- Data cleaning
```
![Library Import](Data Scraping/screenshot/data cleaning.png)
```
### Data Storing
- Create Table
```
![Translasi ERD1](Data Storing/screenshot/create table.png)
```
```
![Translasi ERD1](Data Storing/screenshot/create table2.png)
```
```
![Translasi ERD1](Data Storing/screenshot/create table3.png)
```
- Import Data
```
![Translasi ERD1](Data Storing/screenshot/import_data.png)
```
- Select Table
```
![Translasi ERD1](Data Storing/screenshot/select_isi.png)
```
