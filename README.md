...
<p align="center">
  Kakek kakek cucu anak & menggunakan <em>path</em> SVG sebagai selektor
</p>
...
3. Solusi dan diskusi sudah menyangkut apa yang dilakukan oleh pengguna. Tidak etis melakukan _scraping_ aktivitas pengguna di LeetCode. Sebenarnya bisa saja melakukan _scraping_ mereka tanpa melakukan _scraping_ pengguna yang membuat mereka (data pengguna bisa saja di-_mock_), tetapi saya merasa itu "nanggung". Saya pribadi merasa lebih baik _all in or nothing_.
...
_Key_ 8 didapatkan dari mengambil `href` di elemen `a` pada tabel seluruh _problem_.
...
## Data Visualization : [Fifteen Shades of LeetCode](https://leet-code-insight.vercel.app/)
